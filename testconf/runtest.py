...
command = "pytest -s --html=ReportHtml/report.html" + " " + "TEST"
# command = "pytest -s --alluredir=ReportAllure1/"+ time + "_" + readNewData + " --html=ReportHtml/report_"+ time + "_" + readNewData + ".html --self-contained-html" + " " + "TEST"
os.system(command)
